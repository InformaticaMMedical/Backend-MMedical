...
from ventas.views.cotizacion_views import (CrearCotizacionAPIView, AgregarItemAPIView, ObtenerCotizacionAPIView,
    ActualizarItemCotizacionAPIView, EliminarItemCotizacionAPIView, )
...
urlpatterns = [
    ...
    path("item/<int:item_id>/actualizar/", ActualizarItemCotizacionAPIView.as_view()),
    path("item/<int:item_id>/eliminar/", EliminarItemCotizacionAPIView.as_view()),
]
